    ...
    <main className="h-screen flex flex-col bg-[#0a0a0a] p-5">
      <div className="flex flex-1 gap-4 min-h-0">
        ...
        <div className="w-[450px] shrink-0 flex flex-col gap-0 h-full">
          ...
          {/* Card 1 — Total value */}
          <div style={{ animation: "fade-up 0.5s cubic-bezier(0.22, 1, 0.36, 1) 320ms both" }} className="relative z-[1] rounded-tl-2xl rounded-tr-2xl border border-white/10 bg-[var(--color-card-wallet)] px-6 pt-5 pb-[60px] flex items-center justify-between">
          ...
          {/* Card 2 — 24h P&L */}
          <div style={{ animation: "fade-up 0.5s cubic-bezier(0.22, 1, 0.36, 1) 200ms both" }} className="-mt-[44px] relative z-[2] rounded-2xl border border-white/10 bg-[var(--color-card-pnl)] px-6 pt-5 pb-[60px] flex items-start justify-between">
            <p className="text-xs font-medium text-black/45">24h P&L</p>
            <p className="text-lg font-semibold text-[#0a0a0a]">{pnl24hDisplay}</p>
          </div>

          {/* Card 3 — Holdings */}
          <div style={{ animation: "fade-up 0.5s cubic-bezier(0.22, 1, 0.36, 1) 100ms both" }} className="-mt-[44px] relative z-[3] rounded-2xl border border-white/10 bg-[var(--color-card-holdings)] px-6 pt-5 pb-[60px] flex items-start justify-between">
          ...
          <div style={{ animation: "fade-up 0.5s cubic-bezier(0.22, 1, 0.36, 1) 0ms both" }} className="-mt-[44px] relative z-[4] flex-1 min-h-0 rounded-2xl overflow-hidden">
